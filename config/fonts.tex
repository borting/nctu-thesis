...
%
% * fontname --> 預設中文本文字型
% @ fontname --> 預設中文明體字型 (使用於封面頁)
%-------------------------------------------------------------------------------

% main font for Chinese, leave {} empty if you want to use default font setting
\mainfontzh{}

% ming font (明體), leave {} empty if you want to use default font setting
\mingfontzh{}
